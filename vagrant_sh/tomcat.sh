...
wget http://apache.cp.if.ua/tomcat/tomcat-8/v8.5.35/bin/apache-tomcat-8.5.35.tar.gz -P ${TOMCAT_DOWNLOAD}
tar -zxf ${TOMCAT_DOWNLOAD}/apache-tomcat-8.5.35.tar.gz -C ${TOMCAT_DOWNLOAD}
sudo mv ${TOMCAT_DOWNLOAD}/apache-tomcat-8.5.35 /opt/tomcat
